...
void DropDownScroll::open() {
	...
	EntityHandle menuBoxContent = createEntity(ownerHandle.getEntityName() + "_DropDownBox_Content",
	...
	// Scroll Bar
	EntityHandle scrollBar = createEntity(ownerHandle.getEntityName() + "_DropDownBox_Scroll_Bar",
