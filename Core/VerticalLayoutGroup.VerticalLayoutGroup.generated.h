...
Mirror::Class getTypeImpl() { \
	...
	newClass.name = "VerticalLayoutGroup";\
	newClass.size = sizeof(VerticalLayoutGroup);\
...
static T getValue(ClassType* instance, std::string propertyName) {\
	try {\
		...
		std::cout << "The property VerticalLayoutGroup::" + propertyName + " cannot be converted to the specified type!" << "\n";\
		throw std::invalid_argument("The property VerticalLayoutGroup::" + propertyName + " cannot be converted to the specified type!");\
	}\
	std::cout << "The property VerticalLayoutGroup::" + propertyName + " does not exist in VerticalLayoutGroup!" << "\n";\
	throw std::invalid_argument("The property VerticalLayoutGroup::" + propertyName + " does not exist in VerticalLayoutGroup!");\
}\
...
static std::array<T, N> getValue(ClassType* instance, std::string propertyName) {\
	try {\
		if (propertyName == "shrinkableChildWidth") {\
			throw std::invalid_argument("The property VerticalLayoutGroup::" + propertyName + " is not an array!");\
		}\
		if (propertyName == "shrinkableChildHeight") {\
			throw std::invalid_argument("The property VerticalLayoutGroup::" + propertyName + " is not an array!");\
		}\
...
static void setValue(ClassType* instance, std::string propertyName, T value) {\
	try {\
		...
		std::cout << "The property VerticalLayoutGroup::" + propertyName + " was set to a value with an incompatible type!\n";\
		throw std::invalid_argument("The property VerticalLayoutGroup::" + propertyName + " was set to a value with an incompatible type!");\
	}\
	std::cout << "The property VerticalLayoutGroup::" + propertyName + " does not exist in VerticalLayoutGroup!" << "\n";\
	throw std::invalid_argument("The property VerticalLayoutGroup::" + propertyName + " does not exist in VerticalLayoutGroup!");\
}\
...
static void setValue(ClassType* instance, std::string propertyName, T value[N]) {\
	try {\
		if (propertyName == "shrinkableChildWidth") {\
			throw std::invalid_argument("The property VerticalLayoutGroup::" + propertyName + " is an array!");\
			return;\
		}\
		if (propertyName == "shrinkableChildHeight") {\
			throw std::invalid_argument("The property VerticalLayoutGroup::" + propertyName + " is an array!");\
