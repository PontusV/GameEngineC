...
virtual std::size_t getArraySize(std::string propertyName) {\
	...
	std::cout << "Warning: The property Core::UIBehaviour::" + propertyName + " does not exist or the property is const!" << "\n";\
	throw std::invalid_argument("The property Core::UIBehaviour::" + propertyName + " does not exist or the property is const!");\
}\
