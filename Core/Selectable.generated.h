...
T getValue_impl(std::string propertyName) {\
	try {\
		...
		std::cout << "Warning: The property Core::Selectable::" + propertyName + " cannot be converted to the specified type!" << "\n";\
		throw std::invalid_argument("The property Core::Selectable::" + propertyName + " cannot be converted to the specified type!");\
	}\
	std::cout << "Warning: The property Core::Selectable::" + propertyName + " does not exist!" << "\n";\
	throw std::invalid_argument("The property Core::Selectable::" + propertyName + " does not exist!");\
}\
template<typename T>\
...
bool setValue_impl(std::string propertyName, T value) {\
	try {\
		...
		std::cout << "Warning: The property Core::Selectable::" + propertyName + " was set to a value with an incompatible type!\n";\
		throw std::invalid_argument("The property Core::Selectable::" + propertyName + " was set to a value with an incompatible type!");\
	}\
	std::cout << "Warning: The property Core::Selectable::" + propertyName + " does not exist!" << "\n";\
	throw std::invalid_argument("The property Core::Selectable::" + propertyName + " does not exist!");\
}\
...
virtual std::size_t getArraySize(std::string propertyName) {\
	...
	std::cout << "Warning: The property Core::Selectable::" + propertyName + " does not exist or the property is const!" << "\n";\
	throw std::invalid_argument("The property Core::Selectable::" + propertyName + " does not exist or the property is const!");\
}\
