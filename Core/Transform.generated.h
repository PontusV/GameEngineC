...
T getValue_impl(std::string propertyName) {\
	try {\
		if (propertyName == "position") {\
			return Mirror::convertType<T>(position);\
		}\
		if (propertyName == "z") {\
			return Mirror::convertType<T>(z);\
		}\
		if (propertyName == "rotation") {\
			return Mirror::convertType<T>(rotation);\
		}\
		if (propertyName == "scale") {\
			return Mirror::convertType<T>(scale);\
		}\
...
bool setValue_impl(std::string propertyName, T value) {\
	try {\
		if (propertyName == "position") {\
			Mirror::setVariableValue(position, value);\
			return true;\
		}\
		if (propertyName == "z") {\
			Mirror::setVariableValue(z, value);\
			return true;\
		}\
		if (propertyName == "rotation") {\
			Mirror::setVariableValue(rotation, value);\
			return true;\
		}\
		if (propertyName == "scale") {\
			Mirror::setVariableValue(scale, value);\
			return true;\
		}\
