...
namespace Core {
	...
	public:
		...
		/* Returns the full path of the scene. Returns nullptr if a scene with the given name was not found */
		virtual const wchar_t* getSceneFilePath(const wchar_t* name) = 0;
