...
namespace GameEngine {
	namespace util { //Helpers. Required because (0 + ... + sizeof(Ts)) does not work with static constexpr; the problem is the fold expression.
		template <typename...>
		struct SizeOf;
	...
	*/
	...
	public:
		...
		static constexpr const std::size_t MAX_SIZE = CHUNK_SIZE / (sizeof(Entity) + util::SizeOf<Ts...>::value);
