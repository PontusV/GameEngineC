...
void Shader::setVector2f(const GLchar* name, const Vec2& value, GLboolean useShader)
{
	if (useShader)
		use();
...
void Shader::setVector3f(const GLchar* name, const Vec3& value, GLboolean useShader)
{
	if (useShader)
		use();
...
void Shader::setVector4f(const GLchar* name, const Vec4& value, GLboolean useShader)
{
	if (useShader)
		use();
...
void Shader::setMatrix4(const GLchar* name, const Matrix4& matrix, GLboolean useShader)
{
	if (useShader)
		use();
	glUniformMatrix4fv(glGetUniformLocation(ID, name), 1, GL_FALSE, &matrix.data[0]);
}
